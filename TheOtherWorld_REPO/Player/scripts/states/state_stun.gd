...
func init() -> void:
	# SEGURIDAD: Solo conectar si no está conectada previamente
...
func enter() -> void:
	...
	# Solo vibra la cámara si somos el personaje activo
	if PlayerManager and PlayerManager.player == player:
...
func _player_damaged( _hurt_box : HurtBox ) -> void:
	# SEGURIDAD: Ignorar daño si no somos el personaje activo
